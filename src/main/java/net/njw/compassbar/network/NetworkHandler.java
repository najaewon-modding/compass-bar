...
public final class NetworkHandler {
    ...
    public static void registerPayloads(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(PlayerColorsPayload.TYPE, PlayerColorsPayload.STREAM_CODEC);
        registrar.playToServer(
                CompassSubscriptionPayload.TYPE,
                CompassSubscriptionPayload.STREAM_CODEC,
                (payload, context) -> PlayerPositionSync.setCompassActive(
